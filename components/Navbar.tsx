  ...
  return (
    <nav className={`fixed w-full z-50 transition-all duration-500 ${isScrolled ? 'bg-[#0a0a0a]/95 backdrop-blur-md py-4 shadow-2xl border-b border-white/5' : 'bg-transparent py-8'}`}>
      <div className="container mx-auto px-6 flex justify-between items-center">
        <Link to="/" className="text-2xl font-black serif text-white tracking-tighter">
        ...
        <div className="hidden lg:flex space-x-10 items-center">
          ...
          <Link to="/login" className="px-5 py-2 border border-white/20 text-[9px] uppercase tracking-widest font-black hover:bg-white hover:text-black transition-all">
            Admin
          </Link>
        </div>
